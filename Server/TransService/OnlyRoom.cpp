...
stOnlyRoom::stOnlyRoom(): stBaseRoom(Cmd::ROOM_TYPE_ONLY)
{
	
}


stOnlyRoom::~stOnlyRoom()
{
	
}


void stOnlyRoom::SendRTPData(defSSRCId ssrc_id, const char * recv_buf, const int recv_len)
{
