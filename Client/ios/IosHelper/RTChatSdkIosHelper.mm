...
#import "RTChatSdkIosHelperDelegate.h"
#import <string>
#import "RTChatSdk.h"
...
{
    return RTChatSDKMain::sharedInstance().requestVerifyGM(account.UTF8String, password.UTF8String);
}

///  请求进入GM房间
/// 目前roomid随便发， 防止将来有roomlist来选择
-(bool) requestEnterGMRoom:(uint64_t)roomid
{
    return RTChatSDKMain::sharedInstance().requestEnterGMRoom(roomid);
}
